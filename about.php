...
?>
    <section class="intro">
      ...
      <h2>Our Mission</h2>
      <p>To provide symbols, tools, and reminders that support the journey from chaos to clarity, from shadow to light, from being lost to becoming a Lightbearer.</p>

      <h2>What You’ll Find Here</h2>
      <ul>
        <li><strong>Energy Offerings:</strong> Ritual kits, aura oils, and access codes</li>
        <li><strong>Wearables:</strong> Divine Hoodies and other symbolic apparel</li>
